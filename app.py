...
children = st.number_input('Children', min_value=1, max_value=10, value=2)
...
# region
region_dict = {'southwest': 0, 'northwest': 1, 'southeast': 3, 'northeast': 2}
